<div class="col-10 fourthcolumn  scrollbarr" style="overflow: auto;height:900px;position:fixed" >
                ...
                <div class=" metacontainer vf mt-4 " >
                    <div class="row">
                        ...
                        <div class="col-12">
                            <h6 class="font" style="font-weight:bolder;margin-top:20px ">Accounts Center</h6>
                        </div>


                        <div class="col-12">
                            <p style="font-size:17px;color:#a8a8a8">Manage your connected experiences and<br> account settings across meta technologies.</p>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg style="color:#a8a8a8" aria-label="" class="x1lliihq x1n2onr6 x1roi4f4" fill="currentColor" height="20" role="img" viewBox="0 0 24 24" width="20"><title></title><path d="M2.667 22v-1.355a5.271 5.271 0 0 1 5.271-5.271h8.124a5.271 5.271 0 0 1 5.271 5.271V22" fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></path><circle cx="12" cy="7.268" fill="none" r="5" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></circle></svg>
                                </div>

                                <div class="col-11">
                                    <p style="color:#a8a8a8;margin-top:2px;margin-left:4px">Personal details</p>
                                </div>
                        ...
                        <div class="col-12" style="margin-top:-7px">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg style="color:#a8a8a8" aria-label="" class="x1lliihq x1n2onr6 x1roi4f4" fill="currentColor" height="20" role="img" viewBox="0 0 24 24" width="20"><title></title><path d="M18.44 1H5.56A4.565 4.565 0 0 0 1 5.561v12.878A4.565 4.565 0 0 0 5.56 23h12.88A4.566 4.566 0 0 0 23 18.44V5.56A4.566 4.566 0 0 0 18.44 1ZM21 18.44A2.564 2.564 0 0 1 18.44 21H5.56A2.563 2.563 0 0 1 3 18.44V5.56A2.563 2.563 0 0 1 5.56 3h12.88A2.564 2.564 0 0 1 21 5.561Z"></path><path d="M12 16H6a1 1 0 0 0 0 2h6a1 1 0 0 0 0-2Zm6-10H6a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V7a1 1 0 0 0-1-1Zm-1 6H7V8h10Zm1 4h-2a1 1 0 0 0 0 2h2a1 1 0 0 0 0-2Z"></path></svg>
                                </div>

                                <div class="col-11">
                                    <p style="color:#a8a8a8;margin-top:2px;margin-left:4px">Add preferences</p>
                                </div>
                        ...
                        <div class="col-12 font">
                            <p style="color: #168df5;margin-top:-5px">See more in accounts center</p>
                        </div>

                        <div class="col-12">
                            <p style="color:#a8a8a8;margin-top:15px;margin-left:10px">How you use instagram</p>
                        </div>
                        ...
                        <div class="col-12">
                            <p style="color:#a8a8a8;margin-top:15px;margin-left:10px">Who can see your content</p>
                        </div>

                        <div class="col-12 greybg1">
                            <div class="row">

                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M6.71 9.555h10.581a2.044 2.044 0 0 1 2.044 2.044v8.357a2.044 2.044 0 0 1-2.043 2.043H6.71a2.044 2.044 0 0 1-2.044-2.044V11.6A2.044 2.044 0 0 1 6.71 9.555Zm1.07 0V6.222a4.222 4.222 0 0 1 8.444 0v3.333" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>   
                                </div>

                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Account privacy</h5>
                                </div>
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M12.001.504a11.5 11.5 0 1 0 11.5 11.5 11.513 11.513 0 0 0-11.5-11.5Zm0 21a9.5 9.5 0 1 1 9.5-9.5 9.51 9.51 0 0 1-9.5 9.5Zm4.691-11.82L13.91 9.35l-1.08-2.537a.893.893 0 0 0-1.66 0L10.086 9.35l-2.783.334a.963.963 0 0 0-.493 1.662l2.095 1.905-.606 2.837a.918.918 0 0 0 1.363 1.018l2.335-1.504 2.335 1.504a.918.918 0 0 0 1.363-1.018l-.605-2.837 2.094-1.905a.962.962 0 0 0-.493-1.662Z" fill-rule="evenodd"></path></svg>
                                </div>

                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Close friends</h5>
                                </div>
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M20.153 20.106A11.493 11.493 0 0 0 3.893 3.858c-.007.007-.016.009-.023.016s-.009.016-.015.023a11.493 11.493 0 0 0 16.247 16.26c.01-.009.022-.012.03-.02.01-.01.012-.022.021-.031Zm1.348-8.102a9.451 9.451 0 0 1-2.119 5.968L6.033 4.622a9.49 9.49 0 0 1 15.468 7.382Zm-19 0a9.451 9.451 0 0 1 2.118-5.967l13.35 13.35A9.49 9.49 0 0 1 2.5 12.003Z"></path></svg>
                                </div>

                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Blocked</h5>
                                </div>                             
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M1.545 13.386a1 1 0 0 0 .961-1.037Q2.5 12.174 2.5 12a9.514 9.514 0 0 1 .467-2.955 1 1 0 0 0-1.902-.62A11.53 11.53 0 0 0 .5 12c0 .142.002.283.008.425a1 1 0 0 0 .998.962.52.52 0 0 0 .04-.001Zm1.742 2.424a1 1 0 1 0-1.834.798 11.588 11.588 0 0 0 3.163 4.23A1 1 0 1 0 5.9 19.307a9.581 9.581 0 0 1-2.614-3.497Zm12.828 4.757a9.575 9.575 0 0 1-7.113.45 1 1 0 1 0-.629 1.899 11.545 11.545 0 0 0 8.607-.546 1 1 0 0 0-.865-1.803Zm4.69-1.176A11.495 11.495 0 0 0 12.002.5a1 1 0 0 0 0 2 9.492 9.492 0 0 1 7.382 15.469L2.207.793A1 1 0 0 0 .793 2.207l21 21a1 1 0 0 0 1.414-1.414Z"></path></svg>                                </div>

                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Hide story and live</h5>
                                </div>                             
                        ...
                        <div class="col-12">
                            <p style="color:#a8a8a8;margin-top:15px;margin-left:10px">How others can interact with you</p>
                        </div>
                        ...
                        <div class="col-12 greybg1">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M12.003 2.001a9.705 9.705 0 1 1 0 19.4 10.876 10.876 0 0 1-2.895-.384.798.798 0 0 0-.533.04l-1.984.876a.801.801 0 0 1-1.123-.708l-.054-1.78a.806.806 0 0 0-.27-.569 9.49 9.49 0 0 1-3.14-7.175 9.65 9.65 0 0 1 10-9.7Z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="1.739"></path><path d="M17.79 10.132a.659.659 0 0 0-.962-.873l-2.556 2.05a.63.63 0 0 1-.758.002L11.06 9.47a1.576 1.576 0 0 0-2.277.42l-2.567 3.98a.659.659 0 0 0 .961.875l2.556-2.049a.63.63 0 0 1 .759-.002l2.452 1.84a1.576 1.576 0 0 0 2.278-.42Z" fill-rule="evenodd"></path></svg>                                </div>

                                <div class="col-11">
                                    <h5 style="margin-left:15px;margin-top:2px">Messages and story replies</h5>
                                </div>
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M15.108 13.652a3.342 3.342 0 0 1-3.341 3.342h-.661a2.246 2.246 0 0 1-2.246-2.246v-.634a2.246 2.246 0 0 1 2.246-2.246h3.654" fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></path><path d="M17.521 22h-7.368a6.95 6.95 0 0 1-3.695-.642 4.356 4.356 0 0 1-1.813-1.812 6.96 6.96 0 0 1-.64-3.696v-7.7a6.964 6.964 0 0 1 .64-3.697 4.36 4.36 0 0 1 1.813-1.812A6.952 6.952 0 0 1 10.153 2h3.74a6.95 6.95 0 0 1 3.694.64 4.356 4.356 0 0 1 1.814 1.813 6.956 6.956 0 0 1 .64 3.696v6.464a2.38 2.38 0 0 1-2.38 2.38h-.13a2.423 2.423 0 0 1-2.422-2.422V9.019a2.471 2.471 0 0 0-2.47-2.471h-.994a2.471 2.471 0 0 0-2.47 2.47v.268" fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></path></svg>                                </div>

                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Tags and mentions</h5>
                                </div>
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>                                </div>

                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Comments</h5>
                                </div>                             
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M19.998 9.497a1 1 0 0 0-1 1v4.228a3.274 3.274 0 0 1-3.27 3.27h-5.313l1.791-1.787a1 1 0 0 0-1.412-1.416L7.29 18.287a1.004 1.004 0 0 0-.294.707v.001c0 .023.012.042.013.065a.923.923 0 0 0 .281.643l3.502 3.504a1 1 0 0 0 1.414-1.414l-1.797-1.798h5.318a5.276 5.276 0 0 0 5.27-5.27v-4.228a1 1 0 0 0-1-1Zm-6.41-3.496-1.795 1.795a1 1 0 1 0 1.414 1.414l3.5-3.5a1.003 1.003 0 0 0 0-1.417l-3.5-3.5a1 1 0 0 0-1.414 1.414l1.794 1.794H8.27A5.277 5.277 0 0 0 3 9.271V13.5a1 1 0 0 0 2 0V9.271a3.275 3.275 0 0 1 3.271-3.27Z"></path></svg>                                
                                </div>

                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Sharing and remixes</h5>
                                </div>                             
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M16.546 21.468A10.505 10.505 0 0 1 2.532 7.454m2.043-2.879a10.5 10.5 0 1 1 14.85 14.85" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><path d="M8.027 8.028a4.266 4.266 0 1 1 5.53 5.529m-8.959 5.891a4.27 4.27 0 0 1 4.017-2.822h3.09" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" x1="1.5" x2="22.5" y1="1.5" y2="22.5"></line></svg>
                                </div>

                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Restricted accounts</h5>
                                </div>                             
                        ...
                        <div class="col-12">
                            <p style="color:#a8a8a8;margin-top:15px;margin-left:10px">What you see</p>
                        </div>
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Like and share counts</h5>
                                </div>                             
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M19.269 20H4.73a1 1 0 0 1-.973-.77L1.026 7.641A1 1 0 0 1 2.82 6.84a3.674 3.674 0 0 0 3.666 1.725c1.992-.308 3.74-2.13 4.56-4.754a1 1 0 0 1 1.908 0c.82 2.625 2.567 4.446 4.56 4.754A3.674 3.674 0 0 0 21.18 6.84a1 1 0 0 1 1.794.802L20.242 19.23a1 1 0 0 1-.973.77ZM5.523 18h12.954l1.857-7.878a5.439 5.439 0 0 1-3.126.419A7.506 7.506 0 0 1 12 6.611a7.506 7.506 0 0 1-5.208 3.93 5.437 5.437 0 0 1-3.126-.42Z"></path></svg>
                                </div>

                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Subscriptions</h5>
                                </div>                             
                        ...
                        <div class="col-12">
                            <p style="color:#a8a8a8;margin-top:15px;margin-left:10px">Your app and media</p>
                        </div>
                        ...
                        <div class="col-12 greybg1">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" x1="11.914" x2="11.914" y1="15.195" y2="2"></line><polyline fill="none" points="16.013 11.095 11.914 15.195 7.814 11.095" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polyline><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2" x1="3.277" x2="20.55" y1="22" y2="22"></line></svg>
                                </div>
                                <div class="col-11">
                                    <h5 style="margin-left:15px;margin-top:2px">Archiving and downloading</h5>
                                </div>
                        ...
                        <div class="col-12 greybg1 mt-2">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M3.642 16.11V6.033a1.192 1.192 0 0 1 1.192-1.192h13.433a1.192 1.192 0 0 1 1.192 1.192m-5.343 13.125H3.778A1.778 1.778 0 0 1 2 17.38v-1.27h11.917" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><path d="M22 17.832v.16a1.322 1.322 0 0 1-.121.7.826.826 0 0 1-.343.345 1.316 1.316 0 0 1-.7.121h-2.755a1.315 1.315 0 0 1-.7-.121.826.826 0 0 1-.343-.344 1.321 1.321 0 0 1-.12-.7V10.2a1.321 1.321 0 0 1 .12-.7.826.826 0 0 1 .344-.344 1.315 1.315 0 0 1 .699-.122h2.755a1.315 1.315 0 0 1 .7.122.826.826 0 0 1 .343.343A1.322 1.322 0 0 1 22 10.2v7.632Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
                                </div>
                                <div class="col-10">
                                    <h5 style="margin-left:15px;margin-top:2px">Website permissions</h5>
                                </div>                             
                        ...
                        <div class="col-12">
                            <p style="color:#a8a8a8;margin-top:15px;margin-left:10px">For families</p>
                        </div>
                        ...
                        <div class="col-12">
                            <p style="color:#a8a8a8;margin-top:15px;margin-left:10px">For professionals</p>
                        </div>
                        ...
                        <div class="col-12">
                            <p style="color:#a8a8a8;margin-top:15px;margin-left:10px">More info and support</p>
                        </div>
                        ...
                        <div class="col-12 greybg1">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M3 13.5a9 9 0 0 0 18 0V4.488A17.848 17.848 0 0 1 12 1.5a17.848 17.848 0 0 1-9 2.988Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path><path d="m11.283 7.925-.934 2.094-2.403.277a.785.785 0 0 0-.425 1.372l1.808 1.572-.523 2.342a.785.785 0 0 0 1.177.839L12 15.18l2.017 1.241a.785.785 0 0 0 1.177-.84l-.523-2.341 1.808-1.572a.785.785 0 0 0-.425-1.372l-2.403-.277-.934-2.094a.785.785 0 0 0-1.434 0Z" fill-rule="evenodd"></path></svg>
                                </div>                               
                                <div class="col-11">
                                    <h5 style="margin-left:15px;margin-top:2px">Privacy Center</h5>
                                </div>
                        ...
                        <div class="col-12 greybg1">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <svg aria-label="" class="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30"><title></title><path d="M2.667 22v-1.355a5.271 5.271 0 0 1 5.271-5.271h8.124a5.271 5.271 0 0 1 5.271 5.271V22" fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></path><circle cx="12" cy="7.268" fill="none" r="5" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="2"></circle></svg>
                                </div>                               
                                <div class="col-11">
                                    <h5 style="margin-left:15px;margin-top:2px">Account status</h5>
                                </div>
