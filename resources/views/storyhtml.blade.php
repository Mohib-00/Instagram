<div class="showstorycontainer" style="display: none;">
    <form>
        <div class="col-7 sharestorycolumn">
            <div class="row" style="background: black; padding: 10px 0;">
                <div class="col-5 mt-2">
                    <svg class="mx-4 discardstorysvg" aria-label="Back" fill="currentColor" height="30" role="img" viewBox="0 0 24 24" width="30">
                        <title>Back</title>
                ...
                <div class="col-1 mt-2">
                    <h6 id="shareStoryButton" style="font-weight: lighter; color: #0093f5;" class="font mx-1 sharestory">Share</h6>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-8 contentstorycreate">
                    ...
                    <div id="discardstorycontainer" class="col-5" style="position: absolute; height: 250px; background: #262626; margin-top: -35%; margin-left: 15%; border-radius: 15px; padding: 0px 0px 250px 0px; display: none;">
                        <h3 style="font-weight: lighter; margin-left: 32%; margin-top: 10%;" class="font">Discard Story?</h3>
                ...
                <div class="col-4">
                    <div class="row scrollbar" style="overflow: auto; height: 600px;">
                        ...
                        <div class="col-11">
                            ...
                            <textarea name="story_caption" id="storyInput" style="background: transparent; height: 500px; color: white; margin-left: -15px; padding: 10px; border: none; width: 100%;" class="form-control font mt-4"></textarea>
