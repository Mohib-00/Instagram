    ...
    <div class="container-fluid  " style="background-color:black;height:922px;overflow-y: auto; ">
        <div class="row">
          ...
          @include('sidebar')
            ...
            <div class="col-10 secondcolumn scrollbar" style="overflow-y: auto; " >
                        ...
                        <div class="col-12 fourthcontainercolumn">
                            <div class="row">
                                ...
                                <div class="col-1 postcolumn" id="posts">
                                    ...
                                    <span  class="posttext"   id="posts" style="color:blue; " >Posts</span>
                                </div>
                                ...
                                <div class="col-1  ">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark" viewBox="0 0 16 16">
                                      ...
                                      <span class="posttext">Saved</span>
                                </div>
                                ...
                                <div class="col-1  ">
                                    ...
                                    <span class="posttext"    >Tagged</span>
                                </div>
